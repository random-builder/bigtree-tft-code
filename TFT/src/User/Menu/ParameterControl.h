...
#define IMAGE_NOZZLE_X  2*ICON_WIDTH+ICON_WIDTH/2
#define VALUE_NOZZLE_X  IMAGE_NOZZLE_X+BYTE_WIDTH

#define IMAGE_HOTBED_X  3*ICON_WIDTH+2*BYTE_WIDTH+ICON_WIDTH/2
#define VALUE_HOTBED_X  IMAGE_HOTBED_X+BYTE_WIDTH
