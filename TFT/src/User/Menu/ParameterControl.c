...
{
    {SYMBOL_SETTING1,     LIST_MOREBUTTON,    LABEL_STEPS_SETTING,    _LABEL_EMPTY_},
    {SYMBOL_SETTING1,     LIST_MOREBUTTON,    LABEL_CURRENT_SETTING,  _LABEL_EMPTY_},
...
void setCurrentMenuItems(){
    ...
    LABEL_CURRENT_SETTING,
    // icon                     ItemType        Item Title               item value text(only for custom value)
    {{SYMBOL_BLANK,           LIST_CUSTOMVALUE,     _LABEL_DYNAMIC_,     _LABEL_DYNAMIC_},
    {SYMBOL_BLANK,            LIST_CUSTOMVALUE,     _LABEL_DYNAMIC_,     _LABEL_DYNAMIC_},
    {SYMBOL_BLANK,            LIST_CUSTOMVALUE,     _LABEL_DYNAMIC_,     _LABEL_DYNAMIC_},
    {SYMBOL_BLANK,            LIST_CUSTOMVALUE,     _LABEL_DYNAMIC_,     _LABEL_DYNAMIC_},
    {SYMBOL_BLANK,            LIST_LABEL,           _LABEL_EMPTY_,     _LABEL_EMPTY_},
